...
// const num0=[0,2,4,6,8];
// const num1= [1,3,5,7,9];
// for(let i=num0.length-1;i>=0;i=i-1){
//     console.log(num0[i]);
// }
//     for(let B=num0.length-1;B>0;B=B-1){
//         console.log(num1[B]);
// } 
...
//     job:"student",
// }
// console.log(mohammaddata);
// console.log(mohammaddata.lastname);

// mohammaddata.cuntry ="iran";
// console.log(mohammaddata);
// delete mohammaddata.job;
// console.log(mohammaddata);
...
//     const jasonresult=await res.json();
...
const OddNumber =  [];
const EvenNumber = [];
const Number = [1,2,5,7,9,35,78,12,65];
